                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Icon(Icons.delivery_dining_rounded, size: 64, color: context.colorScheme.primary),
                        const SizedBox(height: AppSpacing.lg),
                        Text(_isLoginMode ? 'Driver Sign In' : 'Become a Driver', style: context.textTheme.headlineMedium),
                        ...
                        if (!_isLoginMode) ...[
                          const SizedBox(height: AppSpacing.lg),
                          Text('Vehicle Type', style: context.textTheme.labelLarge),
                          const SizedBox(height: AppSpacing.sm),
                          SegmentedButton<String>(
                            segments: const [
                              ButtonSegment(value: 'motorcycle', label: Text('Motorcycle')),
                              ButtonSegment(value: 'car', label: Text('Car')),
                              ButtonSegment(value: 'bicycle', label: Text('Bicycle')),
                            ],
                        ...
                        BlocBuilder<AuthFormBloc, AuthFormState>(
                          builder: (context, state) {
                            return AppButton(
                              text: _isLoginMode ? 'Sign In' : 'Create Driver Account',
